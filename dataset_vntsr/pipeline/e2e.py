...
def main():
    ...
    parser.add_argument("--classifier", type=str, default="../weight/resnet18.pth", help="Path to classifier .pth")
    parser.add_argument("--clf_arch", type=str, 
                        choices=["resnet18", "efficientnet", "mobilenetv2", "shufflenetv2"],
                        default="resnet18", help="Classifier architecture")
    
    # Data
    parser.add_argument("--input", type=str, default="../Dataset/E2E/data_e2e_vntsr/images", help="Input image or folder")
    parser.add_argument("--labels", type=str, default="../Dataset/E2E/data_e2e_vntsr/labels", help="Label folder")
    parser.add_argument("--classes", type=str, default="../Dataset/E2E/data_e2e_vntsr/idx2label.json", help="Path to class names file")
